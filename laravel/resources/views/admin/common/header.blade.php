<div id="kt_header" class="header header-fixed">
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        <div class="text-right d-flex align-items-center flex-wrap mr-2" >
            <center class="text-right">
                ...
                @if(Request::segment(1) == 'user' || Request::segment(1) == 'addUser')
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">User/Party Master</h5>
                @endif
                
                @if(Request::segment(1) == 'process')
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Process Master</h5>
                @endif
                
                @if(Request::segment(1) == 'machine')
                    
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Machine Master</h5>
                @endif
        
                
                @if(Request::segment(1) == 'itemcategory')
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Item Category Master</h5>
                @endif
                
                @if(Request::segment(1) == 'itemattribute')
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Item Attribute Master</h5>
                @endif
                
                @if(Request::segment(1) == 'item' || Request::segment(1) == 'itemsssssss')
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Item Master</h5>
                @endif
                ...
                @if(Request::segment(1) == 'purchaseser' || Request::segment(1) == 'addPurchase' || Request::segment(1) == 'purchasesers' || Request::segment(1) == 'purchase')
                ...
                @if(Request::segment(1) == 'purchaseorder' || Request::segment(1) == 'addPurchaseOrder')
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Purchase Order(PO)</h5>
                @endif
        ...
        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                <ul class="menu-nav">
                   <?php 
                   /* <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" 
                    aria-haspopup="true">
        ...
        <div class="topbar">
            ...
            */
            ...
            <div class="topbar-item">
                <div class="w-auto btn-clean d-flex align-items-center" id="kt_quick_user_toggle">
                    <!-- <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                     -->
                  

                    <span>
                        <?php echo !empty($sessionUserData[0]->username) ? $sessionUserData[0]->username : ''; ?>
                    </span>
