...
<script src="{{ URL::asset('public/admin/dist/assets/js/pages/widgets.js?v=7.0.5')}}"></script>
    ...
    @if(Request::segment(1) == 'purchaseorder' || Request::segment(1) == 'item' || Request::segment(1) == 'process' || 
    Request::segment(1) == 'itemcategory' || Request::segment(1) == 'itemattribute' || Request::segment(1) == 'user' 
    || Request::segment(1) == 'itemsssssss' || Request::segment(1) == 'machine')
        
        <script src="{{ URL::asset('public/admin/datatables.net-bs4/js/dataTables.responsive.min.js')}}"></script>
        <script src="{{ URL::asset('public/admin/datatables.net-bs4/js/datatable-basic.init.js')}}"></script>
