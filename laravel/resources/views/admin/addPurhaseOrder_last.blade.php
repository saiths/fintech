                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        @endif
                         ...
                         <form id="register-form"  class="form-horizontal" name="register_form" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <input type="hidden" name="po_id" id="po_id" value="{{!empty($getPurhaseData->id) ? $getPurhaseData->id:''}}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        if (!empty($sessionUserData[0]->user_type) && $sessionUserData[0]->user_type == 3) {
                                            ...
                                            AND user_type = 3 AND id = '.$sessionUserData[0]->id.' ORDER By username ASC ');
                                        ...
                                        ?>   
                                                        ...
                                                        selected="selected"><?php echo $user->party_name; ?></option>
                                            ...
                                            $getUserData = DB::select('SELECT * FROM user_master WHERE is_deleted_status = "N" 
                                            AND user_type = 3 ORDER By username ASC ');
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row has-feedback" style="margin-left:-15px;">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control form-control" name="item_id" id="item_id" style="width: 239%" >
                                                     <option value=""> Select Item Name</option>
                                                            
                                                    <?php

                                if (!empty($sessionUserData[0]->user_type) && $sessionUserData[0]->user_type == 2) {


                                       $editPartyId = 
                                                        !empty($getPurhaseData->party_id) ? $getPurhaseData->party_id : 0;
...
<?php
                                                     ...
                                                     $getItemNameData = DB::select('SELECT * FROM item_master WHERE is_deleted_status = "N" AND  party_id = '.$sessionUserData[0]->id.' ORDER By name ASC ');
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row has-feedback">
                                            ...
                                            <div class="col-md-8">
                                                <textarea class="form-control" rows="2"  id="description" name="description" placeholder="Description" value="{{ !empty($getPurhaseData->description) ? $getPurhaseData->description : '' }}" style="width: 239%">{{ !empty($getPurhaseData->description) ? $getPurhaseData->description : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
