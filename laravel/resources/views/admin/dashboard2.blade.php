                        ...
                        <div class="card-body" style="padding: 0.75rem;"> 
                            <div class="row">
                                ...
                                ?>
                                    ...
                                    <div class="card border-info col-md-2" style="background: #f4f8f9;cursor:pointer;border:3px solid #ffbc34!important;border-radius: 7px;flex: 0 0 18.66667%;
    max-width: 203px;
    border-spacing: unset;
    margin-left: 18px;" onclick="active(1)">

                                        <div class="card-header bg-warning" style="height: 39px;width: 199px;margin-left: -10px;">
                                            <h6 class="m-b-0 text-white text-center">
                                                <i class="ti-server"></i>&nbsp;Active Task
                                            </h6>
                                        </div>
                                    ...
                                    <!-- 2 card -->
                                    <div class="card border-info col-md-2" style="background: #f4f8f9;cursor: pointer;border:3px solid #137eff!important;border-radius: 7px;flex: 0 0 18.66667%;
    max-width: 203px;
    border-spacing: unset;
    margin-left: 12px;" 
                                    onclick="fixed(3)">
                                        <div class="card-header bg-info" style="height: 39px;width: 199px;margin-left: -10px;">
                                    ...
                                    <!-- 3 card -->
                                    <div class="card border-info col-md-2" style="background: #f4f8f9;cursor: pointer;border:3px solid #2b2b2b!important;border-radius: 7px;flex: 0 0 18.66667%;
    max-width: 203px;
    border-spacing: unset;
    margin-left: 12px;" 
                                    onclick="disputed(4)">
                                        <div class="card-header bg-" style="height: 39px;background: #2b2b2b;width: 199px;margin-left: -10px;">
                                    ...
                                    <!-- 4 card -->
                                    <div class="card border-success col-md-2" style="background: #f4f8f9;cursor: pointer;border:3px solid #5ac146!important;border-radius: 7px;flex: 0 0 18.66667%;
    max-width: 203px;
    border-spacing: unset;
    margin-left: 12px;" 
                                    onclick="complete(5)">
                                        <div class="card-header bg-success" style="height: 39px;width: 199px;margin-left: -10px;">
                                ...
                                <?php 
                                    ...
                                    if (!empty(Session::get('sessionUserData')[0][0]->role_id) && Session::get('sessionUserData')[0][0]->role_id == 3) {
                                        ...
                                        if (!empty(Session::get('sessionUserData')[0][0]->role_id) && Session::get('sessionUserData')[0][0]->role_id == 3) {
                                            $requestStyle = 'style="height: 39px;width: 199px;margin-left: -10px;"';
                                        } else {
                                            $requestStyle = 'style="height: 39px;width: 199px;margin-left: -10px;"';
                                        } 
    
                                        if (!empty(Session::get('sessionUserData')[0][0]->role_id) && Session::get('sessionUserData')[0][0]->role_id == 3) {
                                            $attendanceStyle = 'style="height: 39px;width: 199px;margin-left: -10px;"';
                                        } else {
                                            $attendanceStyle = 'style="height: 39px;width: 199px;margin-left: -10px;"';
                                        } 
                                ...
                                <!-- 5 card -->
                                <div class="card border-secondary col-md-2" style="background: #f4f8f9;border:3px solid #6c757d!important;border-radius: 7px;flex: 0 0 18.66667%;
    max-width: 203px;
    border-spacing: unset;
    margin-left: 12px;">
                                    ...
                                    <div class="card-header bg-secondary" <?php echo $requestStyle; ?>>
                                        <!-- <h6 class="m-b-0 text-white text-center"><i class="icon-call-in fa-fw"></i>&nbsp;
                                         ...
                                         -->
                                         <h6 class="m-b-0 text-white text-center"><i class="icon-calender"></i>&nbsp;
                                            Leave Details 
                                        </h6>
                                    </div>
                                    <div class="card-body" style="padding: 0.75rem;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2" style="margin-left: -5px;">
                                                ...
                                                <button class="btn waves-effect waves-light btn-outline-info" alt="default" 
                                                    data-toggle="modal" data-target="#myModal_{{Session::get('sessionUserData')[0][0]->id}}" class="model_img img-responsive" ><i class="icon-eye"></i>&nbsp;&nbsp;View
                                                </button>
                                            </div>


                                            <div class="col-md-2" style="margin-left: 51px;">
                                                <button class="btn waves-effect waves-light btn-outline-success" alt="default" 
                                                onclick="applyLeaveRequest()"><i class="icon-call-in fa-fw"></i>&nbsp;&nbsp;Apply
                                                </button>
                                            </div>
                                        </div>

                                        <!--  <button class="btn waves-effect waves-light btn-outline-secondary" alt="default" 
                                        data-toggle="modal" data-target="#myModal_{{Session::get('sessionUserData')[0][0]->id}}" 
                                        class="model_img img-responsive" style="margin-left: 33px">
                                            <i class="icon-call-in fa-fw"></i>&nbsp; Request
                                        </button>
                                        ...
                                        <div id="myModal_{{Session::get('sessionUserData')[0][0]->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false"   aria-hidden="true" >
                                            <div class="modal-dialog">
                                                <div class="modal-content" style="border-radius: 25px;">
                                                    <div class="modal-header">
                                                        <button type="button" class="close"  data-dismiss="modal"  aria-hidden="true" onclick="calenderPopup({{Session::get('sessionUserData')[0][0]->id}})" id="calenderMain" >×
                                                        </button>
                                                        <h4 class="modal-title text-center" id="myModalLabel"><i class="icon-calender"></i>&nbsp;&nbsp;Leave Details
                                                        </h4> 
                                                    </div>
                                                ...
                                                /*                            $getLeaveReqData = 
                                                    ...
                                                    */
                                                      ...
                                                      $getLeaveReqData = 
                                                      DB::select('SELECT * FROM `leave_request` WHERE is_deleted_status = "N" 
                                   ...
                                   // if (!empty($getLeaveReqData)) {
                                      ...
                                      if (in_array($compareDate, $dateNameArrs)) {
                                       ...
                                       // if ($getLeaveReqData[0]->leave_status == 1) {
                                            ...
                                            echo  "data-toggle='modal' data-target='#sresponsive-modal_".$calenderDate."'";
             ...
             value="<?php echo $part2[3]; ?>">
                           ...
                           <!-- <input type="hidden" name="levelReqId" id="levelReqId_<?php //echo $calenderDate; ?>" 
                                                                                        ...
                                                                                        <?php
                                                                                          ...
                                                                                          /*  $reasonValue = 
                                                                                            ...
                                                                                            ?>      
                                                                                                ...
                                                                                                id="levelReqId_<?php echo $calenderDate; ?>" 
                                                                                                value="<?php echo $part2[3]; ?>">
                                                                                            <?php 
                                                                                                    ...
                                                                                                    ?>  
                                                                                                            ...
                                                                                                            <div class="col-md-3">
                                                                                                                <a href="#" <?php echo $style; ?>
                                                                                                                    onclick="deleteLeaveRequest(<?php echo $part2[3]; ?>,<?php echo $paddingDates; ?>,'<?php echo $calenderDate; ?>')"  class="btn btn-sm btn-danger pull-right" id="delete_button_<?php echo $calenderDate; ?>" > Cancel Leave
                                                                                                                </a>
                                                                                                            </div>
                                                                                                            <?php 
                                                                                                            }
                            ...
                            ?>
                                ...
                                <div class="card border-info col-md-2" style="background: #f4f8f9;border:3px solid #7460ee!important;border-radius: 7px;flex: 0 0 18.66667%;
    max-width: 203px;
    border-spacing: unset;
    margin-left: 12px;">
                                    <div class="card-header bg-primary" <?php echo $attendanceStyle;?>>
                                        ...
                                        <?php 
                                            if (!empty(Session::get('sessionUserData')[0][0]->id)) {
                                                ...
                                                FROM `attendance` WHERE is_deleted_status = "N" AND  user_id = '.$userId.' AND date = "'.$date.'"');
                                            }
...
?>
                                            ...
                                            <ul class="dropdown-menu" style="border:none;margin:-4px -224px;">

                                                

<?php 
    } else if (!empty(Session::get('sessionUserData')[0][0]->role_id) && (Session::get('sessionUserData')[0][0]->role_id == 1 || Session::get('sessionUserData')[0][0]->role_id == 1)) {

 
?>
    
                                                <ul class="dropdown-menu" style="border:none;margin:-4px -287px;">
...
<?php } ?>
                                    ...
                                    <?php 
                                        if (!empty(Session::get('sessionUserData')[0][0]->id)) {
                                            $userId = Session::get('sessionUserData')[0][0]->id;
                                            $date = date('d-m-Y');
                                            $firstCheckInStatus = DB::select('SELECT count(*) as firstCheckIn FROM `attendance`  
                                            WHERE is_deleted_status = "N" AND  user_id = '.$userId.' AND date 
                                            = "'.$date.'"'); 
                                            if ($firstCheckInStatus[0]->firstCheckIn == 0) {
                                            ?>
                                                <button class="btn btn-success" id="checkinId"  style="margin-top:4px;margin-left: 29px;" 
                                            ...
                                            <?php 
                                                ...
                                                style="margin-top:4px;margin-left: 29px;"><i class="icon-login" ></i>&nbsp;&nbsp;Check In</button>
                                                ...
                                                @foreach ($getTicketData as  $key => $ticket)
                                                    <tr @if($ticket->status == 'No')
                                                        ...
                                                        <?php
                                                            ...
                                                            is_deleted_status = "N" AND  ticket_id = '.$ticket->id.'
                                                            ORDER BY id ASC LIMIT 1');
                                                            $ticketStatusUserId =
                                                            !empty($getUserIdByTicket[0]->user_id) ?
                                                            $getUserIdByTicket[0]->user_id : 0;
                                                    ...
                                                    ?>
                                                    <td>
                                                        <span class="label label-rounded label-secondary" data-toggle="tooltip" data-placement="top" title=""  
                                                        data-original-title="<?php echo wordwrap($ticket->created_at,1); ?>"  
                                                        style="font-size: 12px;color: #fff;background-color: #6c757d;border-color: #6c757d;">Date</span>
                                                    </td>
                                                    <td>
...
<?php 
} else if(!empty(Session::get('sessionUserData')[0][0]->role_id) && (Session::get('sessionUserData')[0][0]->role_id == 1 || 
Session::get('sessionUserData')[0][0]->role_id == 3)) {
?>
                                                   ...
                                                   <!-- <td style="display:none;">{{ $ticket->id }}</td>-->
                                                    ...
                                                    <td id="changeStatus_{{$ticket->id}}">  
                                                        @if($ticket->defaultStatus == 1)
                                                            <span class="label label-rounded label-{{$ticket->statusColour}} pull-left" 
                                                            style="margin-left:5px;{{$ticket->style}}">{{$ticket->ticketStatus}}</span>
                                                        @else
                        ...
                        <h4 class="modal-title" id="myModalLabel">{{$ticket->ticket_no}} - Ticket Detail</h4>
                                ...
                                <span class="tooltiptext">Project Name</span>
                                                                            ...
                                                                            <?php 
                                                                                $getTagsName = !empty($ticket->tags_name) ? $ticket->tags_name : 0;
                                                                                $getTagsDatas = DB::select('SELECT * FROM tags WHERE is_deleted_status = "N" AND 
                                                                                id IN('.$getTagsName.')');
                                                                            ?>
                                                                                ...
                                                                                <div class="row" style="margin-top:2px;">
                                                                                    ...
                                                                                    ?>        
                                                                                                <div class="row">
                                                                                                    <div class="col-md-12">
                                                                                                        <div class="tooltip2" style="border:none;margin-left:10px;">
                                                                                                            <button class="btn btn-danger btn-rounded" style="color: #fff;padding:2px 8px;"><i class="icon-equalizer"></i>&nbsp;<?php echo $tags->tags_name;  ?></button>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                            ...
                                                                            <?php /*@if($ticket->priority != 0 && $ticket->severity != 0)
                                                                                <div class="row" style="margin-top:2px;">
                                                                            ...
                                                                            */?>
                                                                            ...
                                                                            @if($ticket->compittionDate != "")
                                                                                ...
                                                                                <div class="row" style="margin-top:2px;" >
                                                                                    <div class="col-md-12">
                                                                                        <div class="tooltip278" style="border:none;">
                                                        ...
                                                        <a class="btn waves-effect waves-light btn-rounded btn-primary" 
                                                        href="#" role="button" alt="default" data-toggle="modal" data-target="#myModal_{{$ticket->id}}" 
                                                        style="padding: 0px 7px;font-size: 13px;color:white">More Detail</a>
                                                    </td>
                                                    <?php                                 
                                                    if (!empty(Session::get('sessionUserData')[0][0]->role_id) &&  
                                                    Session::get('sessionUserData')[0][0]->role_id != 3) { 
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            ...
                                                            <a href="#" onclick="popupClose({{$ticket->id}})" alt="default" data-toggle="modal" 
                                                                data-target=".bs-example-modal-lg_{{$ticket->id}}" data-backdrop="static" data-keyboard="false"
                                                                class="btn btn-xs btn-info" style="padding: 0px 7px;"><i class="ti-pencil-alt"></i></a>
                                                            
                                                            <!--<div class="tooltip7" style="border:none;">
                                                                <a href="{{ route('aticket.viewbyid',['ticketId' =>  base64_encode($ticket->id)]) }}" 
                                                                class="btn btn-xs btn-info" style="padding: 0px 7px;"><i class="ti-pencil-alt"></i></a>
                                                                <span class="tooltiptext">View/Process</span>
                                                            </div>-->
                                                            
                                                            <div class="modal bs-example-modal-lg_{{$ticket->id}}" tabindex="-1" role="dialog" 
                                                                aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                                                <div class="modal-dialog modal-xl" style="max-width:80%">
                                                                    <div class="modal-content" style="border-radius: 25px;">
                                                                        <div class="modal-header" style="display:flex;">
                                                                            <!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>-->
                                                                            <h4 class="modal-title text-uppercase col-md-4" id="myLargeModalLabel" style="color:black;"><b>{{ $ticket->projectName }}</b></h4>
                                                                            <h4 class="modal-title col-md-4" id="myLargeModalLabel" style="color:black;display:none"><b>Complition Date :</b> {{ $ticket->compittionDate }}</h4>
                                                                            <h4 class="modal-title col-md-4 text-uppercase" id="myLargeModalLabel" style="color:black;"><b>Comments</b></h4>
                                                                        </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-8 col-xlg-8 col-md-8">
                                                                                    ...
                                                                                    aria-labelledby="pills-timeline-tab">
                                                                                                <div class="card-body">
                                                                                               -->     
                                                                                                   <!-- <div class="profiletimeline m-t-0" style="margin:1px 10px 0px 30px;border:none">-->
                                                                                                        ...
                                                                                                        <form id="register-form"  name="register_form" method="post" enctype="multipart/form-data" autocomplete="off">
                                                                                                                ...
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                            <b style="color:black">Title :</b></b> </label>
                                                                                                                        <div class="col-md-10">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                            <b style="color:black">Ticket No : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                                                {{!empty($ticket->ticket_no) ? $ticket->ticket_no:''}}
                                                                                                                            </label>
                                                                                                                        </div>
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                            <b style="color:black">Issue Date : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                                                {{!empty($ticket->createDate) ? $ticket->createDate:''}}
                                                                                                                            </label>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Description : </b></label>
                                                                                                                        <div class="col-md-10" style="height:250px;overflow-y: scroll;">
                                                                                                                            <?php echo !empty($ticket->description) ? $ticket->description : ''; ?>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            ...
                                                                                                            ?>
                                                                                                                <div class="row">
                                                                                                                    <div class="col-md-12">
                                                                                                                        <div class="form-group row">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                                <b style="color:black">Attachement(s) : </b></label>
                                                                                                                            <div class="col-md-10">
                                                                                                                                <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                                                    <?php 
                                                                                                                                        $i = 1;
                                                                                                                                        foreach ($getTicketAttachmentData as $attachment) {
                                                                                                                                            ...
                                                                                                                                            $ticketNoStr = $ticket->ticket_no.'_';
                                                                                                                                            $finalFileName = str_replace($ticketNoStr, '', $attachment->attachment);
                                                                                                                                            $htmlAtt .='<a class="control-label text-left col-form-label" 
                                                                                                                                            href="'.$uploadPath.'/'.$attachment->attachment.'" 
                                                                                                                                            target="_blank" download="'.$finalFileName.'">'.$finalFileName.'</a> , ';
                                                                                                                                        }
                                                                                                                                        echo rtrim($htmlAtt,' ,');
                                                                                                                                    ?>                                                                                                                                       
                                                                                                                                </lable>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                            <b style="color:black">Assign User : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <?php echo $ticket->userAssingNames;?>
                                                                                                                        </div>
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                            <b style="color:black">Assign Date : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                                                {{!empty($ticket->assignDates) ? $ticket->assignDates:''}}
                                                                                                                            </label>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                            <b style="color:black">Set Status : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <select class="form-control select2" onchange="changeStatus({{$ticket->id}})" 
                                                                                                                                style="width: 100%; height:50px;border:1px solid #e74a25!important"  
                                                                                                                                id="ticket_status_id_{{$ticket->id}}" name="ticket_status_id_{{$ticket->id}}" >
                                                                                                                                <?php
                                                                                                                                    ...
                                                                                                                                    $getTicketStatusData = DB::select('SELECT * FROM ticket_status_master WHERE 
                                                                                                                                    is_deleted_status = "N" AND   status IN(2,3,4)');
                                                                                                                                ?>
                                                                                                                                @if (!empty($ticketStatusId))
                                                                                                                                    @if($ticketStatusId != 1)
                                                                                                                                        @if (!empty($getTicketStatusData))
                                                                                                                                    ...
                                                                                                                                    @else
                                                                                                                                        @if (!empty($getTicketStatusData))
                                                                                                                                            ...
                                                                                                                                            @foreach ($getTicketStatusData as $ticketStatus)  
                                                                                                                                                <option value="{{$ticketStatus->status}}">{{$ticketStatus->ticket_status}}</option>
                                                                                                                                            @endforeach
                                                                                                                                        @endif
                                                                                                                                    @endif
                                                                                                                                @endif
                                                                                                                            </select>
                                                                                                                            <span class="text-danger" id="userIdMsg_{{$ticket->id}}"></span>
                                                                                                                        </div>
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                            <b style="color:black">Tags : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <?php 
                                                                                                                                $getTagsName = !empty($ticket->tags_name) ? $ticket->tags_name : 0;
                                                                                                                                $getTagsDatas = DB::select('SELECT * FROM tags WHERE is_deleted_status = "N" 
                                                                                                                                AND id IN('.$getTagsName.')');
                                                                                                                            ?>
                                                                                                                            <?php      
                                                                                                                                if (!empty($getTagsDatas)) {
                                                                                                                                    foreach ($getTagsDatas as $tags) {
                                                                                                                            ?>          
                                                                                                                                        <button class="btn btn-danger btn-rounded btn-xs" 
                                                                                                                                        style="color: #fff;"><?php echo $tags->tags_name;  ?></button>
                                                                                                                                    <?php
                                                                                                                                    }  
                                                                                                                                }  
                                                                                                                            ?>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label">
                                                                                                                            <b style="color:black">Remark :</b></b> </label>
                                                                                                                        <div class="col-md-10">
                                                                                                                            <input type="text" class="form-control borderred_border" id="remark_{{$ticket->id}}" 
                                                                                                                            name="remark_{{$ticket->id}}" placeholder="Remark" value="">
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        ...
                                                                                                                        <div class="col-md-10">
                                                                                                                            <button type="submit" onclick="addTickets({{$ticket->id}})" id="addTicket_{{$ticket->id}}" 
                                                                                                                            class="btn btn-success">Save</button>
                                                                                                                            <button type="button" onclick="closeTicket({{$ticket->id}})" 
                                                                                                                            data-dismiss="modal" 
                                                                                                                            aria-hidden="true" class="btn waves-effect waves-light btn-dark">Close</button>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                ...
                                                                                                <div class="card-body">
                                                                                                    <div class="profiletimeline m-t-0" style="margin:1px 10px 0px 30px;">
                                                                                                        <?php 
                                                                                                            $ticketRemark = '';    
                                                                                                            $ticketId = !empty($ticket->id) ? $ticket->id : 0;
                                                                                                            $getTicketRemarkData = DB::select('SELECT * FROM  ticket_status WHERE 
                                                                                                            is_deleted_status = "N" AND  
                                                                                                            ...
                                                                                                            @foreach ($getTicketRemarkData as $key => $remarkData)  
                                                                                                                <div class="sl-item">
                                                                                                                    @if(!empty($remarkData->remark))
                                                                                                                        <div class="sl-left">
                                                                                                                            <img src="{{ URL::asset('public/admin/theme2/assets/images/users/1.jpg')}}" 
                                                                                                                        ...
                                                                                                                        <div class="sl-right">
                                                                                                                            <div>
                                                                                                                                <a href="#" class="link">
                                                                                                                                    <?php 
                                                                                                                                        $getUserNameRemark = 
                                                                                                                                        DB::select('SELECT username FROM user_master WHERE 
                                                                                                                                        is_deleted_status = "N" AND  
                                                            ...
                                                            @if($ticket->ticketStatus=='New')
                                                                @if($ticket->createTicketRole==1)
                                                                    <div class="tooltip7" style="border:none;">
                                                                        ...
                                                                        onclick="deleteTicketData({{$ticket->id}})" 
                                                                        style="padding: 0px 7px;"><i class="ti-trash"></i></a>
...
else if(!empty(Session::get('sessionUserData')[0][0]->role_id) && (Session::get('sessionUserData')[0][0]->role_id == 4))
{
?>
...
?>
    ...
    ?>
        ...
        <script type="text/javascript">
            ...
            function addTickets(ticketId) {
                $("#addTicket_"+ticketId).html('<i class="fa fa-spinner fa-spin"></i>&nbsp;&nbsp;Saving');
                $("#addTicket_"+ticketId).attr("disabled", true);
                var remark = $("#remark_"+ticketId).val();
                var ticketStatusId = $("#ticket_status_id_"+ticketId).val();
                if (ticketStatusId != 0 || ticketStatusId != '') {
                    $.ajax({
                        type : "GET",
                        url  : '{{route("addTicketStatusPopup")}}',
                        data : {  
                            remarks:remark,
                            ticketStatusIds:ticketStatusId,
                            ticketIds:ticketId
                        },
                        success: function(data) {
                    ...
                    $("#userIdMsg_"+ticketId).show();
                    $("#userIdMsg_"+ticketId).html('Please Select Status');
                    $("#addTicket_"+ticketId).attr("disabled", false);
                    $("#addTicket_"+ticketId).html('Save');
                }
            }
            
            function changeStatus(ticketId) {
                $("#userIdMsg_"+ticketId).hide();
            }
        ...
        <script type="text/javascript">
            ...
            function popupClose(ticketId=null) {
