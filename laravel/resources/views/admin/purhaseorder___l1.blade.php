                                                    ...
                                                    foreach ($getPurchaseOrderData as $key => $itemData) {
                                                        ...
                                                        if (!empty($partyUserData)) {
                                                            ...
                                                            foreach ($partyUserData as  $partyNameData) {
                                                                ...
                                                                $partyNames[] =  !empty($partyNameData->party_name) ? $partyNameData->party_name : 0;
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    name="po_id_{{$itemData->id}}" class="form-control borderred" placeholder="PoId" 
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>{{ $itemCatName[$i] }}
                                                                                                    ...
                                                                                                    value="{{ !empty($itemCatNameId[$i]) ? $itemCatNameId[$i] : $itemCatNameId[$i] }}" >
                                                                                                </td>
                                                                                            </tr>
...
<!--                                                                             <div class="modal-header" 
 ...
 -->
  ...
  .padding0tbl td {
    ...
    .padding0tbl th, .padding0tbl td{    vertical-align: middle;}

                                                                            </style>

                                                                            <div class="modal-body">
                                                                                <div class="my-custom-scrollbar">
                                                                                <table class="padding0tbl table table-bordered table-hover table-checkable col-lg-12" id="kt_datatable" >
                                                                                    <thead>
                                                                                        <tr>
                                                                                            <th>No.</th>
                                                                                            <th>Process Name</th>
                                ...
                                $jobCardProcessListArr = DB::select('SELECT * FROM job_card_process_list WHERE is_deleted_status = "N" AND job_card_id = '.$jobCardId.' ');
                            ...
                            $process_item_category_master = DB::select('SELECT * FROM process_item_category_master WHERE is_deleted_status = "N" 
                                AND item_category_id = '.$itemCategoryId[$i].'');
                                                                                            ...
                                                                                            $process_masters = DB::select('SELECT * FROM process_master WHERE is_deleted_status = "N" AND id IN('.$processIds.') ');
                                ...
                                name="note_{{$itemData->id}}[]" placeholder="{{$process->name}} - Date" style="float:right;"  value="" class="form-control">
                                                                                ...
                                                                                <div data-scroll="true"  class="row"> 
                                                                                    <div class="modal-footer col-sm-3" 
                                                                                        ...
                                                                                        <button type="button" disabled="" class="btn btn-info font-weight-bold pull-right" 
