...
?>
                        <div class="card-body" style="padding: 0.75rem;"> 
                            <div class="row">
                                ...
                                ?>
                                    <!-- 1 card -->
                                    <div class="card border-info col-md-2" style="background: #f4f8f9;cursor:pointer;border:3px solid #ffbc34!important;" onclick="active(1)">
                                                                                                   ...
                                                                                                   <!-- <div class="profiletimeline m-t-0" style="margin:1px 10px 0px 30px;border:none">-->
                                                                                                        ...
                                                                                                        <form id="register-form"  name="register_form" method="post" enctype="multipart/form-data" autocomplete="off">
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Title :</b></b> </label>
                                                                                                                        <div class="col-md-10">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                                                {{!empty($ticket->titles) ? $ticket->titles:''}}
                                                                                                                            </label>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Ticket No : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                                                {{!empty($ticket->ticket_no) ? $ticket->ticket_no:''}}
                                                                                                                            </label>
                                                                                                                        </div>
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Issue Date : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        ...
                                                                                                                        <div class="col-md-10" style="height:250px;overflow-y: scroll;"><?php echo !empty($ticket->description) ? $ticket->description : ''; ?></div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            @endif
                                                                                                            ...
                                                                                                            ?>
                                                                                                                <div class="row">
                                                                                                                    <div class="col-md-12">
                                                                                                                        <div class="form-group row">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Attachement(s) : </b></label>
                                                                                                                            <div class="col-md-10">
                                                                                                                                <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                                                    <?php 
                                                                                                                                        $i = 1;
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Assign User : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <?php echo $ticket->userAssingNames;?>
                                                                                                                        </div>
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Assign Date : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <label for="inputEmail3" class="control-label text-right col-form-label">
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Set Status : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                        ...
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Tags : </b></label>
                                                                                                                        <div class="col-md-4">
                                                                                                                            <?php 
                                                                                                                                $getTagsName = !empty($ticket->tags_name) ? $ticket->tags_name : 0;
                                                                                                                            ...
                                                                                                                            <?php      
                                                                                                                                if (!empty($getTagsDatas)) {
                                                                                                                                    foreach ($getTagsDatas as $tags) {
                                                                                                                            ?>          
                                                                                                                                        <button class="btn btn-danger btn-rounded btn-xs" style="color: #fff;"><?php echo $tags->tags_name;  ?></button>
                                                                                                                                    <?php
                                                                                                                                    }  
                                                                                                                                }  
                                                                                                                            ?>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black">Remark :</b></b> </label>
                                                                                                                        <div class="col-md-10">
                                                                                                                            <input type="text" class="form-control borderred_border" id="remark_{{$ticket->id}}" name="remark_{{$ticket->id}}" placeholder="Remark" value="">
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group row">
                                                                                                                        <label for="inputEmail3" class="control-label text-right col-md-2 col-form-label"><b style="color:black"></b> </label>
                                                                                                                        <div class="col-md-10">
                                                                                                                            <button type="submit" onclick="addTickets({{$ticket->id}})" id="addTicket_{{$ticket->id}}" class="btn btn-success">Save</button>
                                                                                                                            <button type="button" onclick="closeTicket({{$ticket->id}})" data-dismiss="modal" 
