...
?>
                        <div class="card-body" style="padding: 0.75rem;"> 
                            <div class="row">
                                                                                ...
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header">
                                                                                            ...
                                                                                            onclick="closeLeave('<?php echo $calenderDate; ?>',<?php echo $day; ?>,<?php echo date('d'); ?>)" 
                                                                                            ...
                                                                                            <form id="reason_form_<?php echo $calenderDate; ?>" >
                                                                                                ...
                                                                                                <div class="row" style="margin-top: 10px;display: none;" >
                                                                                                    ...
                                                                                                    ?>      
                                                                                                            <div class="col-md-3">
                                                                                                                <a href="#" 
                                                                                                                onclick="deleteLeaveRequest('<?php echo $getLeaveReqPadding[0]->id; ?>,<?php echo $paddingDates; ?>,'<?php echo $calenderDate; ?>')"  
                                ...
                                <div class="card border-info col-md-2"></div>
                                <div class="card border-info col-md-2"></div>
                                <div class="card border-info col-md-2"></div>
                                <div class="card border-info col-md-2"></div>
                                <!-- 2 card -->
                                            ...
                                            <ul class="dropdown-menu" style="border:none;margin:-4px -275px;">
                                                ...
                                                <div class="modal-sm">
                                                    ...
                                                    <table class="table-bordered" style="width: 128%;background-color: #f4f8f9">  
                                                        ...
                                                        <tbody>
                                                            <?php 
                                    $getAttendanceData = DB::select('SELECT * FROM attendance WHERE is_deleted_status = "N" AND date = "'.$date.'" AND user_id = '.$userId.'');
                                                            ?>
                                ...
                                <div class="card-body" style="padding: 0.5rem;color: black">&nbsp;
                                    ...
                                    <?php 
                                        if (!empty(Session::get('sessionUserData')[0][0]->id)) {
                                            ...
                                            ?>
                                                <button class="btn btn-success" id="checkinId"  style="margin-top:5px;margin-left: 5px;" 
...
<?php 
    ...
    if (!empty(Session::get('sessionUserData')[0][0]->role_id) && (Session::get('sessionUserData')[0][0]->role_id == 0 || Session::get('sessionUserData')[0][0]->role_id == 0)) {
?>
